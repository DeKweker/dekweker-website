  ...
  return (
    <div className="page-shell">
      ...
      <section className="media-lead-grid" data-scroll-scene>
        <div className="media-lead-photo" data-depth="24"><Image src="/assets/live/plukketuffer-wijkplanken-2026-08-19.jpg" alt="De Kweker live tijdens Wijkplanken / PlukkeTuffer" fill priority sizes="(max-width: 900px) 100vw, 58vw" /></div>
